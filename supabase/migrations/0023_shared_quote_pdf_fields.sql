-- Suma al RPC publico de cotizacion compartida los campos que el nuevo
-- formato de PDF necesita: consecutivo, ciudad del cliente, comercial
-- responsable, descripcion de producto, y el contenido editable de la
-- version (mensaje de introduccion, condiciones comerciales, nota).
