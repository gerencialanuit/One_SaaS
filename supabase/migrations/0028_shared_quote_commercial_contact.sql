-- El PDF debe mostrar el cargo y el email comercial del vendedor (campos
-- editables en Usuarios), no su email de login.
...
begin
  ...
  select json_build_object(
    ...
    'commercial_cargo', pr.cargo,
    'commercial_email', coalesce(pr.commercial_email, pr.email),
